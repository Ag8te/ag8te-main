            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              ...
              <Box>
                ...
                <Typography
                  ...
                  sx={{ color: "text.secondary", mb: 2 }}
                >
                  Complete these steps to start receiving service bookings:
                </Typography>
                <Stack spacing={1}>
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                    ...
                    >
                      {user.id_verification_status === "verified"
                        ? "Documents verified"
                        : "Upload your ID documents via your profile"}
                    </Typography>
                  </Box>
                </Stack>
              </Box>
      ...
      switch (activeTab) {
                          ...
                          data={[
                            {
                              ...
                              earnings: parseFloat(
                                (
                                  (data?.professional_earnings || 0) * 0.2
                                ).toFixed(2),
                              ),
                            },
                            {
                              ...
                              earnings: parseFloat(
                                (
                                  (data?.professional_earnings || 0) * 0.4
                                ).toFixed(2),
                              ),
                            },
                            {
                              ...
                              earnings: parseFloat(
                                (
                                  (data?.professional_earnings || 0) * 0.7
                                ).toFixed(2),
                              ),
                            },
                            {
                              name: "This Week",
                              earnings: data?.professional_earnings || 0,
                            },
                          ]}
                        >
                          <CartesianGrid
        ...
        case "reviews":
          return (
            ...
            >
              ...
              <Box sx={{ p: 0 }}>
                {data?.recent_professional_jobs?.filter(
                  (r: any) => r.details?.professional_rating,
                ).length > 0 ? (
                  data.recent_professional_jobs
                    .filter((r: any) => r.details?.professional_rating)
                    .map((job: any) => (
                      <Box
                        key={job.id}
                        sx={{
                      ...
                      >
                            ...
                            {[1, 2, 3, 4, 5].map((star) => (
                              <StarIcon
                                ...
                                sx={{
                                  ...
                                  color:
                                    star <=
                                    (job.details?.professional_rating || 0)
                                      ? "warning.main"
                                      : "divider",
                                }}
                              />
                        ...
                        >
                          "
                          {job.details?.professional_review ||
        ...
        case "services":
          return (
            <Box sx={{ animation: "fadeIn 0.5s" }}>
              <ServiceManagement
                initialServices={data?.professional_services || []}
                role="professional"
              />
            </Box>
          );
          ...
          return (
            <ComplianceDocuments
              ...
              registrationReviewStatus={
                data?.current_user?.registration_review_status ?? null
              }
            />
          );
        case "profile":
